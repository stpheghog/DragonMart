...
@WebServlet(name = "AdminEditListing", urlPatterns = {"/admin/do.editlisting"})
public class AdminEditListing extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String uri = "../WEB-INF/jsp/admin/editlisting.jsp";
        String error = "";
        int parsedID = 0;
        ...
        if (id == null || id.isEmpty()) {
            ...
            error += "NO LISTING ID<br>";
            uri = "/WEB-INF/jsp/admin/listingview.jsp";
        ...
        try {
            ...
            error += "Cannot parse listing ID<br>";
        ...
        try {
            ...
            error += "Cannot fetch listing from DB<br>";
            uri = "/WEB-INF/jsp/admin/error.jsp";
        }
