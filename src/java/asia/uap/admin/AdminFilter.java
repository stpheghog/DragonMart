...
public class AdminFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        // Skips check for login.jsp or do.auth
        
        if (!requestURI.endsWith("login.jsp") && !requestURI.contains("do.auth")) {
            // checks for all admin pages (anything under /admin/)
            if (requestURI.startsWith(req.getContextPath() + "/admin/")) {
                Admin admin = (Admin) sesh.getAttribute("admin");
                if (admin == null) {
                    // If not logged in, redirect to login.jsp with error message
