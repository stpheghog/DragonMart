...
@WebServlet(name = "AdminItemView", urlPatterns = {"/admin/do.listingview"})
public class AdminItemView extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String errmsg = "";
        String uri = "/WEB-INF/jsp/admin/listingview.jsp";

        if (listingId == null || listingId.isEmpty()) {
            errmsg="No listing ID provided<br>";
        ...
        try {
            ...
            parsedID = 0;
            ex.printStackTrace();
            errmsg+="Cannot parse integer<br>";
            uri = "/WEB-INF/jsp/admin/error.jsp";
        }
        ...
        if(listing!=null){
            ...
            request.setAttribute("ownerUsername", listing.getOwnername());
        }
