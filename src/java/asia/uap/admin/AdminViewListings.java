 ...
 */
@WebServlet(name = "AdminViewListings", urlPatterns = {"/admin/do.viewlistings"})
public class AdminViewListings extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String uri = "/WEB-INF/jsp/admin/viewlistings.jsp";
        ...
        try {
            ownerListings = listingIO.getAllListings();

        } catch (SQLException e) {
            e.printStackTrace();
            error+="cannot get all listings<br>";
            uri = "/WEB-INF/views/admin/error.jsp";
        }
