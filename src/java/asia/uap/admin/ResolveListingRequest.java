 ...
 */
@WebServlet(name = "ResolveListingRequest", urlPatterns = {"/admin/do.resolvelistingrequest"})
public class ResolveListingRequest extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (requestIdParam == null || requestIdParam.isEmpty() ||
            listingIdParam == null || listingIdParam.isEmpty() ||
        ...
        if(error.isEmpty()){
            ...
            try {
                // Handle the approval or denial of the delete listing request
                if ("approve".equals(action)) {
                    // Approve the listing delete request
                    reqIO.approveDeleteListingRequest(requestId, listingId);
                } else if ("deny".equals(action)) {
                    // Deny the profile update request
                    reqIO.denyDeleteListingRequest(requestId);
                } else {
