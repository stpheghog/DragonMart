 ...
 * @author Stephanie
 */
@WebServlet(name = "EditStock", urlPatterns = {"/user/do.editstock"})
public class EditStock extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("type", "Edit Stock");
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/jsp/listing/editstock.jsp");
