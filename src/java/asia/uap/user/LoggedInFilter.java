 ...
 */
@WebFilter(filterName = "LoggedInFilter", urlPatterns = {"/user/*"})
public class LoggedInFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        HttpSession sesh = (HttpSession) req.getSession();
        
        
        User user = (User) sesh.getAttribute("loggedin");
        if(user==null){
            resp.sendRedirect(req.getContextPath() + "/login.jsp?error=YOU%20ARE%20NOT%20LOGGED%20IN");
            return;
        }
