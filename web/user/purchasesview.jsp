...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class = 'container'>
                <a href='do.viewtransaction?type=Purchase' class='message-button'>View Purchases</a>
                <br><br><a href='do.viewtransaction?type=Sale' class='message-button'>View Sales</a>
                </div>
        </div>
    </body>
